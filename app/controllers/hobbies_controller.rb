class HobbiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @hobby.save
        ...
        format.html { redirect_to '/profile#addMoreHobbies', notice: 'Hobby was successfully created.' }
        format.json { render :show, status: :created, location: @hobby }
        format.js { redirect_to '/profile#addMoreHobbies', notice: 'Hobby was successfully created.' }
      else
  ...
  private
    ...
    def hobby_params
      params.require(:hobby).permit(:hobby_icon, :hobby_name, :user_id)
    end
end
