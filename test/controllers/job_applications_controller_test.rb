...
class JobApplicationsControllerTest < ActionController::TestCase
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post :create, job_application: { apply_job_info: @job_application.apply_job_info, job_id: @job_application.job_id, price_per_hour: @job_application.price_per_hour, user_id: @job_application.user_id }
    end
  ...
  test "should update job_application" do
    patch :update, id: @job_application, job_application: { apply_job_info: @job_application.apply_job_info, job_id: @job_application.job_id, price_per_hour: @job_application.price_per_hour, user_id: @job_application.user_id }
    assert_redirected_to job_application_path(assigns(:job_application))
  end
